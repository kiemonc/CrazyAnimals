...
public class AnimalCreator implements IAnimalCreator{
	 ...
	 */
	private Cat createCat(IField field) 	{ return new Cat  (random.nextInt(80), random.nextInt(80), random.nextInt(80), random.nextBoolean(), field, random); }
	/**
	 ...
	 */
	private Cow createCow(IField field)     { return new Cow  (random.nextInt(80), random.nextInt(80), random.nextInt(80), random.nextBoolean(), field, random); }
	/**
	 ...
	 */
	private Wolf createWolf(IField field)   { return new Wolf (random.nextInt(80), random.nextInt(80), random.nextInt(80), random.nextBoolean(), field, random); }
	/**
	 ...
	 */
	private Mouse createMouse(IField field) { return new Mouse(random.nextInt(80), random.nextInt(80), random.nextInt(80), random.nextBoolean(), field, random); }
	/**
	 ...
	 */
	private Sheep createSheep(IField field) { return new Sheep(random.nextInt(80), random.nextInt(80), random.nextInt(80), random.nextBoolean(), field, random); }
}
